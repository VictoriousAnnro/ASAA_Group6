...
Actors: Customer, Web Server
Preconditions: The chosen car can be customized before purchase
Steps:
...
Actors: Production Orchestrator
Preconditions: The production run for a placed order has been scheduled. 
Steps:
