...
\begin{center}
\begin{tabular}{ | m{0.7cm} | m{4cm}| m{1cm} | m{1cm} | }
 \hline
 Req ID & Description & Type & QA \\ 
 \hline
 RQ1 & Customer can choose from a list of available cars & Func & Us\\ 
 \hline
 RQ2 & Customer should be able to chose a car and customize the car's model, engine and color & type & qa\\ 
 \hline
 RQ3 & Scheduler should prepare a placed order for production by creating and saving a production recipe & type & Perf\\
 \hline
 RQ4 & Scheduler should keep track of an order's status (ready, in progress, completed) & type & per\\
 \hline
 RQ5 & The website should respond to user actions in less than 3 seconds & type & Perf\\
 \hline
 RQ6 & Any order placed on the website should be saved and marked as 'ready' for production in database within 10 time units & type & Perf\\ 
 \hline
\end{tabular}
\label{ReqTabel}
\end{center}
