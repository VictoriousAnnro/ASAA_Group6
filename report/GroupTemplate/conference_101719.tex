...
\cite{ContinousEngineeringI4} evaluates performance to improve system but only at run-time.
...
\cite{AQuality4Modelforarchitectingindustry}This study proposes a model-driven approach by transforming software architecture into performance models, allowing performance to be analyzed early in the development process.
