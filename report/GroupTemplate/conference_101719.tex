...
For each order, the scheduler printed the measured end-to-end processing time. All observed durations were well below the 10-second requirement, with typical values in the range of a few seconds. The results demonstrate that:
\begin{itemize}[leftmargin=*]
...
Name & Contribution\\
Anne-Marie Rommerdahl & Scheduler, Kafka, Introduction, Problem and Approach, Use case, Design and Analysis Modelling, Formal Verification and Validation\\
...
\appendix
\includepdf[pages={1}]{ASAA_results.pdf}
