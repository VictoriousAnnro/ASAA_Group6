...
Based on the QAS and the use case, several requirements were defined, which can be seen in table \ref{ReqTabel}[FIX TABLE LABEL!!]. 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{SchedulerFAA.jpg}
