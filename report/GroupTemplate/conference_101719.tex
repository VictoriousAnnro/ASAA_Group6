...
In total, seven papers are investigated. 
...
The results for all 50 test-orders can be seen in figure \ref{results1} and \ref{results2}. 
\begin{figure}[h!]
...
Name & Contribution\\
Anne-Marie Rommerdahl & Scheduler, Kafka, Introduction, Problem and Approach, Use case, Design and Analysis Modelling, Formal Verification and Validation, Evaluation (Analysis)\\
JannatulFardous & Website,Introduction,Related Work,Design and Analysis Modelling\\
Wiktor & Automated Experiment, Evaluation\\
